...
function mostraAlternativas() {
    ...
    function mostraResultado() {
        caixaPerguntas.textContent = "Em 2049 erickson...";
        textoResultado.textContent = historiaFinal;
        caixaAlternativas.textContent = "Achou assustador pensar que uma máquina agora poderiam mudar o mundo.Percebeu que a IA consegue explicar termos complicados de formas simplificada e isso ajudou muito suas pesquisas sobre assuntos complexos. Percebeu que muitas pessoas não sabem ainda utilizar as ferramentas tradicionais e decidiu compartilhar seus conhecimentos de design utilizando ferramentas de pinturas digital para iniciantes.";
    }
